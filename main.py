...
classification_task_num = 1  # first classif. task out of 7
kfold_num = 3

# generate .nc files for tasks 3-7
for classification_task_num in xrange(2, 7):
    ...
    if __name__ == '__main__':
        ...
        # 1st classification task out of 7
        # col = 0
